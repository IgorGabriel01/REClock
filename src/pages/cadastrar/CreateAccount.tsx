            ...
            <section className={styles.cadastrar}>
                ...
                <form className={styles.form}>
                    ...
                    <form className={styles.form}>
                        ...
                        <Link className={styles.link} to={"/sucess-create-account"} onClick={(e) => {
                    ...
                    <p className={styles.ftext}>Ao clicar em cadastra-se, você concorda com nossos <Link className={styles.linkpl} to={'/termos-privacidade'}><span>termos de serviço e política de privacidade</span></Link></p>
                </form>
            </section>
